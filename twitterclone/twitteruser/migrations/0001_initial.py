# Generated by Django 3.0.3 on 2020-02-25 07:54
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('Completed', 'Completed'), ('In Progress', 'In Progress'), ('Invalid', 'Invalid'), ('New', 'New')], default='New', max_length=50)),
                ('assign_to_user', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='assign_to_user', to=settings.AUTH_USER_MODEL)),
